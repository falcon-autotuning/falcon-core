...
# Class falcon\_core::autotuner\_interfaces::names::Channels



[**ClassList**](annotated.md) **>** [**falcon\_core**](namespacefalcon__core.md) **>** [**autotuner\_interfaces**](namespacefalcon__core_1_1autotuner__interfaces.md) **>** [**names**](namespacefalcon__core_1_1autotuner__interfaces_1_1names.md) **>** [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md)



_A collection of channels.._ 
...
| Type | Name |
| ---: | :--- |
|   | [**Channels**](#function-channels-12) () <br>[_**Channels**_](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) _can be constructed in 5 different ways:_ |
|   | [**Channels**](#function-channels-22) (const std::vector&lt; std::shared\_ptr&lt; [**Channel**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channel.md) &gt; &gt; & vec) <br> |
|  bool | [**operator!=**](#function-operator) (const [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md#function-channels-12) & other) const<br> |
|  bool | [**operator==**](#function-operator_1) (const [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md#function-channels-12) & other) const<br> |
...
### function Channels [1/2]

[_**Channels**_](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) _can be constructed in 5 different ways:_
```C++
falcon_core::autotuner_interfaces::names::Channels::Channels () 
```




* Default constructor: creates an empty [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) container. 
```C++
Channels o;
```

* Sized constructor: creates an [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) container with a given number of default-initialized elements. 
...
* Fill constructor: creates an [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) container with a given number of copies of a specified value. 
...
* Vector constructor: creates an [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) container from an existing vector of BaseConnectionSP. 

**Parameters:**


  * `vec` Vector of ChannelSP to copy. 
```C++
...
* Initializer list constructor: creates a [**Channels**](classfalcon__core_1_1autotuner__interfaces_1_1names_1_1Channels.md) container from an initializer list of shared pointers. 
...
### function Channels [2/2]

```C++
falcon_core::autotuner_interfaces::names::Channels::Channels (
    const std::vector< std::shared_ptr< Channel > > & vec
) 
```
...
```C++
bool falcon_core::autotuner_interfaces::names::Channels::operator!= (
...
------------------------------
The documentation for this class was generated from the following file `cpp/include/falcon_core/autotuner_interfaces/names/Channels.hpp`
