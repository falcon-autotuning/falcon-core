...
| Type | Name |
| ---: | :--- |
|   | [**GateGeometryArray1D**](#function-gategeometryarray1d-13) (const GateGeometryArray1D & other) <br> |
...
|  bool | [**operator!=**](#function-operator) (const GateGeometryArray1D & other) const<br> |
|  GateGeometryArray1D & | [**operator=**](#function-operator_1) (const GateGeometryArray1D & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const GateGeometryArray1D & other) const<br> |
...
```C++
using falcon_core::physics::config::geometries::GateGeometryArray1D::const_iterator = 
