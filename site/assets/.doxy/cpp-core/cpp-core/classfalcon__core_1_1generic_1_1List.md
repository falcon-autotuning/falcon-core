...
Inherited by the following classes: [falcon\_core::math::Axes](classfalcon__core_1_1math_1_1Axes.md)
...
| Type | Name |
| ---: | :--- |
|   | [**List**](#function-list-16) (const List&lt; Value &gt; & other) <br> |
...
|  std::conditional\_t&lt; std::is\_same&lt; typename [**category::determine\_bool\_tag**](structfalcon__core_1_1generic_1_1category_1_1determine__bool__tag.md)&lt; Value &gt;::type, [**category::bool\_tag**](structfalcon__core_1_1generic_1_1category_1_1bool__tag.md) &gt;::value, StoredValue, const StoredValue & &gt; | [**at**](#function-at-12) (const size\_t idx) const<br> |
|  std::conditional\_t&lt; std::is\_same&lt; typename [**category::determine\_bool\_tag**](structfalcon__core_1_1generic_1_1category_1_1determine__bool__tag.md)&lt; Value &gt;::type, [**category::bool\_tag**](structfalcon__core_1_1generic_1_1category_1_1bool__tag.md) &gt;::value, StoredValue, StoredValue & &gt; | [**at**](#function-at-22) (const size\_t idx) <br> |
...
|  std::shared\_ptr&lt; List&lt; Value &gt; &gt; | [**intersection**](#function-intersection) (const std::shared\_ptr&lt; List&lt; Value &gt; &gt; & other) const<br>_Finds the intersection between this list and another._  |
|  const Container | [**items**](#function-items-12) () const<br> |
|  Container | [**items**](#function-items-22) () <br> |
|  bool | [**operator!=**](#function-operator) (const List&lt; Value &gt; & other) const<br> |
|  List | [**operator=**](#function-operator_1) (const List&lt; Value &gt; & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const List&lt; Value &gt; & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; List&lt; Value &gt; &gt; | [**allocate**](#function-allocate) (size\_t count) <br> |
|  std::shared\_ptr&lt; List&lt; Value &gt; &gt; | [**create**](#function-create) (const Container & init) <br> |
|  std::shared\_ptr&lt; List&lt; Value &gt; &gt; | [**create\_empty**](#function-create_empty) () <br> |
|  std::shared\_ptr&lt; List&lt; Value &gt; &gt; | [**fill\_value**](#function-fill_value) (size\_t count, const StoredValue & value) <br> |
...
|  bool | [**operator\_equal\_impl**](#function-operator_equal_impl-13) (const List&lt; Value &gt; & other, [**category::song\_tag**](structfalcon__core_1_1generic_1_1category_1_1song__tag.md)) const<br> |
|  bool | [**operator\_equal\_impl**](#function-operator_equal_impl-23) (const List&lt; Value &gt; & other, [**category::primitive\_tag**](structfalcon__core_1_1generic_1_1category_1_1primitive__tag.md)) const<br> |
|  bool | [**operator\_equal\_impl**](#function-operator_equal_impl-33) (const List&lt; Value &gt; & other, [**category::other\_tag**](structfalcon__core_1_1generic_1_1category_1_1other__tag.md)) const<br> |
...
```C++
inline std::conditional_t< std::is_same< typename category::determine_bool_tag < Value >::type, category::bool_tag >::value, StoredValue, const StoredValue & > falcon_core::generic::List::at (
    const size_t idx
) const
```
...
```C++
inline std::conditional_t< std::is_same< typename category::determine_bool_tag < Value >::type, category::bool_tag >::value, StoredValue, StoredValue & > falcon_core::generic::List::at (
    const size_t idx
) 
```
...
```C++
using falcon_core::generic::List< Value >::StoredValue = 
