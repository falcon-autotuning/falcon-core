...
```C++
using falcon_core::physics::config::geometries::DotGateWithNeighborsSP =  std::shared_ptr<DotGateWithNeighbors>;
```
...
```C++
using falcon_core::physics::config::geometries::DotGatesWithNeighborsSP =  std::shared_ptr<DotGatesWithNeighbors>;
```
...
```C++
using falcon_core::physics::config::geometries::GateGeometryArray1DSP =  std::shared_ptr<GateGeometryArray1D>;
```
...
```C++
using falcon_core::physics::config::geometries::HasImplantedOhmicSP =  std::shared_ptr<HasImplantedOhmic>;
```
...
```C++
using falcon_core::physics::config::geometries::HasLeftNeighborSP =  std::shared_ptr<HasLeftNeighbor>;
```
...
```C++
using falcon_core::physics::config::geometries::HasRightNeighborSP =  std::shared_ptr<HasRightNeighbor>;
```
...
```C++
using falcon_core::physics::config::geometries::LeftReservoirWithImplantedOhmicSP = 
...
```C++
using falcon_core::physics::config::geometries::RightReservoirWithImplantedOhmicSP = 
