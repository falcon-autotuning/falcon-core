...
|  double | [**convert\_value\_to**](#function-convert_value_to) (const double value, const std::shared\_ptr&lt; Unit &gt; & target\_unit) const<br>_Convert a value from this unit to a target unit._  |
|  TotalDimensions | [**dimensions**](#function-dimensions) () const<br>_Dimensions of this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_giga**](#function-get_giga) () const<br>_Apply a giga prefix to this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_kilo**](#function-get_kilo) () const<br>_Apply a kilo prefix to this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_mega**](#function-get_mega) () const<br>_Apply a mega prefix to this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_micro**](#function-get_micro) () const<br>_Apply a micro prefix to this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_milli**](#function-get_milli) () const<br>_Apply a milli prefix to this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_nano**](#function-get_nano) () const<br>_Apply a nano prefix to this unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**get\_pico**](#function-get_pico) () const<br>_Apply a pico prefix to this unit._  |
|  bool | [**is\_compatible\_with**](#function-is_compatible_with) (const std::shared\_ptr&lt; Unit &gt; & other) const<br>_Check if this unit is compatible with another unit._  |
|  double | [**offset**](#function-offset) () const<br>_Offset from base unit._  |
|  bool | [**operator!=**](#function-operator) (const Unit & other) const<br> |
|  std::shared\_ptr&lt; Unit &gt; | [**operator\***](#function-operator_1) (const std::shared\_ptr&lt; Unit &gt; & other) const<br>_Multiply this unit by another unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**operator/**](#function-operator_2) (const std::shared\_ptr&lt; Unit &gt; & other) const<br>_Divide this unit by another unit._  |
|  bool | [**operator==**](#function-operator_3) (const Unit & other) const<br> |
|  std::shared\_ptr&lt; Unit &gt; | [**operator^**](#function-operator_4) (const int power) const<br>_Raise the unit to a power._  |
...
|  std::shared\_ptr&lt; Unit &gt; | [**with\_prefix**](#function-with_prefix) (const std::string prefix) const<br>_Apply a prefix to this unit._  |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; Unit &gt; | [**Ampere**](#function-ampere) () <br>_A special constructor to build a ampere unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Candela**](#function-candela) () <br>_A special constructor to build a candela unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Celsius**](#function-celsius) () <br>_A special constructor to build a celsius unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Coulomb**](#function-coulomb) () <br>_A special constructor to build a coulomb unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Dimensionless**](#function-dimensionless) () <br>_A special constructor to build a dimensionless unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**ElectronVolt**](#function-electronvolt) () <br>_A special constructor to build a electronvolt unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Fahrenheit**](#function-fahrenheit) () <br>_A special constructor to build a fahrenheit unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Farad**](#function-farad) () <br>_A special constructor to build a farad unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Henry**](#function-henry) () <br>_A special constructor to build a henry unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Hertz**](#function-hertz) () <br>_A special constructor to build a hertz unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Hour**](#function-hour) () <br>_A special constructor to build a hour unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Joule**](#function-joule) () <br>_A special constructor to build a joule unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Kelvin**](#function-kelvin) () <br>_A special constructor to build a kelvin unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Kilogram**](#function-kilogram) () <br>_A special constructor to build a kilogram unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Meter**](#function-meter) () <br>_A special constructor to build a meter unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Minute**](#function-minute) () <br>_A special constructor to build a minute unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Mole**](#function-mole) () <br>_A special constructor to build a mole unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Newton**](#function-newton) () <br>_A special constructor to build a newton unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Ohm**](#function-ohm) () <br>_A special constructor to build a ohm unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Pascal**](#function-pascal) () <br>_A special constructor to build a pascal unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Percent**](#function-percent) () <br>_A special constructor to build a percent unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Radian**](#function-radian) () <br>_A special constructor to build a radian unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Second**](#function-second) () <br>_A special constructor to build a second unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Siemens**](#function-siemens) () <br>_A special constructor to build a seimen unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Tesla**](#function-tesla) () <br>_A special constructor to build a tesla unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Volt**](#function-volt) () <br>_A special constructor to build a volt unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Watt**](#function-watt) () <br>_A special constructor to build a watt unit._  |
|  std::shared\_ptr&lt; Unit &gt; | [**Weber**](#function-weber) () <br>_A special constructor to build a weber unit._  |
