...
| Type | Name |
| ---: | :--- |
|   | [**Adjacency**](#function-adjacency-13) (const Adjacency & other) <br> |
...
|  Indexes | [**indexes**](#function-indexes) () const<br>_Returns the indexes of the gates in the order for the adjacency matrix._  |
|  bool | [**operator!=**](#function-operator) (const Adjacency & other) const<br> |
|  Adjacency & | [**operator=**](#function-operator_1) (const Adjacency & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const Adjacency & other) const<br> |
