...
| Type | Name |
| ---: | :--- |
|   | [**Discretizer**](#function-discretizer-13) (const Discretizer & other) <br> |
...
|  bool | [**operator!=**](#function-operator) (const Discretizer & other) const<br> |
|  Discretizer & | [**operator=**](#function-operator_1) (const Discretizer & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const Discretizer & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; Discretizer &gt; | [**CartesianDiscretizer**](#function-cartesiandiscretizer) (const double & delta) <br>_Constructs a CartesianDiscretizer for Cartesian square axes._  |
|  std::shared\_ptr&lt; Discretizer &gt; | [**PolarDiscretizer**](#function-polardiscretizer) (const double & delta) <br>_Construct a PolarDiscretizer for polar angled coordinates._  |
