...
```C++
using falcon_core::physics::config::core::AdjacencySP =  std::shared_ptr<Adjacency>;
```
...
```C++
using falcon_core::physics::config::core::ConfigSP =  std::shared_ptr<Config>;
```
...
```C++
using falcon_core::physics::config::core::GroupSP =  std::shared_ptr<Group>;
```
...
```C++
using falcon_core::physics::config::core::StandardConfigConnectionsSP =  std::shared_ptr<StandardConfigConnections>;
```
...
```C++
using falcon_core::physics::config::core::VoltageConstraintsSP =  std::shared_ptr<VoltageConstraints>;
```
