...
| Type | Name |
| ---: | :--- |
|   | [**Point**](#function-point-14) (const Point & other) <br> |
...
|  bool | [**operator!=**](#function-operator) (const Point & other) const<br> |
|  std::shared\_ptr&lt; Point &gt; | [**operator\***](#function-operator_1) (double scalar) const<br> |
|  std::shared\_ptr&lt; Point &gt; | [**operator+**](#function-operator_2) (const std::shared\_ptr&lt; Point &gt; & other) const<br> |
|  std::shared\_ptr&lt; Point &gt; | [**operator-**](#function-operator-) (const std::shared\_ptr&lt; Point &gt; & other) const<br> |
|  std::shared\_ptr&lt; Point &gt; | [**operator-**](#function-operator-_1) () const<br> |
|  std::shared\_ptr&lt; Point &gt; | [**operator/**](#function-operator_3) (double scalar) const<br> |
|  Point & | [**operator=**](#function-operator_4) (const Point & other) <br> |
|  bool | [**operator==**](#function-operator_5) (const Point & other) const<br> |
