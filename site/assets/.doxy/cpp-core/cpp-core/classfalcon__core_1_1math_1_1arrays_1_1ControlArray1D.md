...
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**abs**](#function-abs) () const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**flip**](#function-flip) (size\_t axis) const<br>_Flip the data along the given axis._  |
...
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**max**](#function-max-23) (const std::shared\_ptr&lt; ControlArray1D &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**max**](#function-max-33) (const std::shared\_ptr&lt; FArray&lt; double &gt; &gt; & other) const<br> |
| virtual double | [**min**](#function-min-13) () const<br>_Return the minimum value of the array._  |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**min**](#function-min-23) (const std::shared\_ptr&lt; ControlArray1D &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**min**](#function-min-33) (const std::shared\_ptr&lt; FArray&lt; double &gt; &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator\***](#function-operator) (const double other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator\***](#function-operator_1) (const int other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator+**](#function-operator_2) (const double other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator+**](#function-operator_3) (const int other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator+**](#function-operator_4) (const std::shared\_ptr&lt; ControlArray1D &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator+**](#function-operator_5) (const std::shared\_ptr&lt; FArray &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator-**](#function-operator-) (const double other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator-**](#function-operator-_1) (const int other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator-**](#function-operator-_2) (const std::shared\_ptr&lt; ControlArray1D &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator-**](#function-operator-_3) (const std::shared\_ptr&lt; FArray&lt; double &gt; &gt; & other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator-**](#function-operator-_4) () const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator/**](#function-operator_6) (const double other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator/**](#function-operator_7) (const int other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**operator^**](#function-operator_8) (const double other) const<br> |
|  std::shared\_ptr&lt; ControlArray1D &gt; | [**reshape**](#function-reshape) (const std::vector&lt; size\_t &gt; & shape) const<br>_Return a new Array with the given shape._  |
...
```C++
generic::ListSP< generic::FArray < double > > falcon_core::math::arrays::ControlArray1D::gradient () const
```
