...
|  AdjacencyHandle | [**Adjacency\_from\_json\_string**](#function-adjacency_from_json_string) (StringHandle json) <br> |
...
|  ConnectionsHandle | [**Adjacency\_indexes**](#function-adjacency_indexes) (AdjacencyHandle handle) <br>_Returns the indexes of the gates in the order for the adjacency matrix._  |
...
|  StringHandle | [**Adjacency\_to\_json\_string**](#function-adjacency_to_json_string) (AdjacencyHandle handle) <br> |
...
_Returns the indexes of the gates in the order for the adjacency matrix._ 
```C++
