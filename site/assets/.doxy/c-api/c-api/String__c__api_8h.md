...
| Type | Name |
| ---: | :--- |
|  StringHandle | [**String\_create**](#function-string_create) (const char \* raw, size\_t length) <br> |
|  void | [**String\_destroy**](#function-string_destroy) (StringHandle handle) <br> |
|  StringHandle | [**String\_wrap**](#function-string_wrap) (const char \* raw) <br> |
