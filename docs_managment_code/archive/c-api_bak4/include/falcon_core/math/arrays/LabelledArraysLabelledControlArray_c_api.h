...
ListAcquisitionContextHandle LabelledArraysLabelledControlArray_labels(
    LabelledArraysLabelledControlArrayHandle handle);
// @category:read
/* AUTO-DOC from cpp: LabelledArraysLabelledControlArray_is_control_arrays | falcon_core::math::arrays::LabelledArrays::is_control_arrays */
/**
...
bool LabelledArraysLabelledControlArray_is_control_arrays(
    LabelledArraysLabelledControlArrayHandle handle);
// @category:read
/* AUTO-DOC from cpp: LabelledArraysLabelledControlArray_is_measured_arrays | falcon_core::math::arrays::LabelledArrays::is_measured_arrays */
/**
