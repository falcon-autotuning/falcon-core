...
def main() -> None:
    ...
    cpp_doc = len(cpp_doc_from_headers)
    ...
    port_pct = (100.0 * len(ported_from_headers) / cpp_doc) if cpp_doc else 0.0
    ...
    print(f"  C++ functions with Doxygen (from headers): {cpp_doc}")
