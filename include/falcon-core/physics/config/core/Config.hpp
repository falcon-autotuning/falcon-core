...
namespace generic {
extern template class Map<autotuner_interfaces::names::Channel,
...
class FALCON_CORE_CPP_API Config : public StandardConfigConnections {
  ...
  double _max_safe_diff, _min_bound, _max_bound;
...
public:
   ...
   * @param adjacency The adjacency matrix representing the device layout.
   * @param max_safe_diff The maximum safe voltage difference between adjacent
   * @param min_bound The minimum voltage bound for the device.
   * @param max_bound The maximum voltage bound for the device.
   */
  ...
  /**
   * @brief Returns the adjacency matrix representing the device layout.
   */
  AdjacencySP adjacency() const;
  /**
   * @brief Returns the maximum safe voltage difference between adjacent gates.
   */
  double max_safe_diff() const;
  /**
   * @brief Returns the minimum voltage bound for the device.
   */
  double min_bound() const;
  /**
   * @brief Returns the maximum voltage bound for the device.
   */
  ...
  get_impedance(const device_structures::ConnectionSP &connection) const;
  /**
   ...
   */
  bool
  ohmic_in_charge_sensor(const device_structures::ConnectionSP &ohmic) const;
  /**
  ...
  get_gname(const autotuner_interfaces::names::ChannelSP &channel) const;
  /**
  ...
  get_group_dot_gates(const autotuner_interfaces::names::GnameSP &gname) const;
  /**
   ...
   */
  device_structures::ConnectionsSP
  get_group_gates(const autotuner_interfaces::names::GnameSP &gname) const;
  /**
   * @brief Gets all of the barrier gates assocated with the selected
   ...
   * no match is found.
   */
  autotuner_interfaces::names::ChannelsSP
  return_channels_from_gate(const device_structures::ConnectionSP &gate) const;
  /**
   ...
   */
  autotuner_interfaces::names::ChannelSP
  return_channel_from_gate(const device_structures::ConnectionSP &gate) const;
  /**
...
protected:
  ...
  template <class Archive> inline void serialize(Archive &ar) {
    ...
    ar(cereal::base_class<StandardConfigConnections>(this),
       _num_unique_channels, _wiring_DC, _channels, _groups, _adjacency,
       _max_safe_diff, _min_bound, _max_bound);
  }
};
