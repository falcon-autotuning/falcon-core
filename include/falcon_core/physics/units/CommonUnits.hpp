...
static const Unit Meter{SI::DIMENSIONS_METER, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Kilogram{SI::DIMENSIONS_KILOGRAM, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Second{SI::DIMENSIONS_SECOND, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Ampere{SI::DIMENSIONS_AMPERE, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Kelvin{SI::DIMENSIONS_KELVIN, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Mole{SI::DIMENSIONS_MOLE, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Candela{SI::DIMENSIONS_CANDELA, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Hertz{SI::DIMENSIONS_HERTZ, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Newton{SI::DIMENSIONS_NEWTON, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Pascal{SI::DIMENSIONS_PASCAL, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Joule{SI::DIMENSIONS_JOULE, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Watt{SI::DIMENSIONS_WATT, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Coulomb{SI::DIMENSIONS_COULOMB, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Volt{SI::DIMENSIONS_VOLT, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Farad{SI::DIMENSIONS_FARAD, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Ohm{SI::DIMENSIONS_OHM, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Siemens{SI::DIMENSIONS_SIEMENS, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Weber{SI::DIMENSIONS_WEBER, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Tesla{SI::DIMENSIONS_TESLA, 1.0, 0.0, SI::UNIT_SYMBOL};
static const Unit Henry{SI::DIMENSIONS_HENRY, 1.0, 0.0, SI::UNIT_SYMBOL};
...
static const Unit Radian{
    SI::DIMENSIONS_DIMENSIONLESS, 1.0, 0.0, SI::UNIT_SYMBOL};
/*
