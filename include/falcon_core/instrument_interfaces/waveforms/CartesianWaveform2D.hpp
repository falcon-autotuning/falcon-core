...
/**
 * @brief A 2D measurement on a cartesian domain with any time-dependent phenomena.
 */
namespace falcon_core {
namespace instrument_interfaces {
namespace waveforms {

class CartesianWaveform2D : public BaseWaveform<falcon_core::math::discrete_spaces::CartesianDiscreteSpace> {
 public:
  using space_type = falcon_core::math::discrete_spaces::CartesianDiscreteSpace;
  using base_type = BaseWaveform<space_type>;

  CartesianWaveform2D(std::shared_ptr<space_type> space,
...
#ifndef SWIG
CEREAL_REGISTER_TYPE(falcon_core::instrument_interfaces::waveforms::CartesianWaveform2D)
CEREAL_REGISTER_POLYMORPHIC_RELATION(falcon_core::generic::Song, falcon_core::instrument_interfaces::waveforms::CartesianWaveform2D)
#endif
