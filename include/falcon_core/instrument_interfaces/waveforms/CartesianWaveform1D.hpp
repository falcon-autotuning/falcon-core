...
/**
 * @brief A 1D measurement on a cartesian domain with any time-dependent phenomena.
 */
namespace falcon_core {
namespace instrument_interfaces {
namespace waveforms {

class CartesianWaveform1D : public BaseWaveform<falcon_core::math::discrete_spaces::CartesianDiscreteSpace1D> {
 public:
  using space_type = falcon_core::math::discrete_spaces::CartesianDiscreteSpace1D;
  using base_type = BaseWaveform<space_type>;

  CartesianWaveform1D(std::shared_ptr<space_type> space,
  ...
  static std::shared_ptr<CartesianWaveform1D> from_division(
    ...
    auto space = space_type::from_division(division, shared_domain, increasing, domain);
...
#ifndef SWIG
CEREAL_REGISTER_TYPE(falcon_core::instrument_interfaces::waveforms::CartesianWaveform1D)
CEREAL_REGISTER_POLYMORPHIC_RELATION(falcon_core::generic::Song, falcon_core::instrument_interfaces::waveforms::CartesianWaveform1D)
#endif
