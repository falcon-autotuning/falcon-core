...
public:
    PortTransform(std::shared_ptr<AnalyticFunction> function) : _function(std::move(function)) {}
    ...
    nlohmann::json to_json() const override {
        nlohmann::json j;
        add_metadata(j, "falcon_core.physics.transforms.port_transform", "PortTransform");
        if (_function) {
