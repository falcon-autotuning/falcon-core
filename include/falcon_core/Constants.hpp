...
constexpr const char* ALL_PREFIXES[] = {YOCTO_SYMBOL,
                                        ZEPTO_SYMBOL,
                                        ATTO_SYMBOL,
                                        FEMTO_SYMBOL,
                                        PICO_SYMBOL,
...
constexpr const char* ALL_DIMENSIONS[] = {DIMENSION_LENGTH,
                                          DIMENSION_MASS,
                                          DIMENSION_TIME,
                                          DIMENSION_CURRENT,
...
// The following (maps and std::string objects) cannot be constexpr const char*:
