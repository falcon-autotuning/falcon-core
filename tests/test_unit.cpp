...
//
//   ASSERT_EQ(mm.symbol(),
//             std::string(SI::MILLI_SYMBOL) +
//             std::string(SI::UNIT_SYMBOL_METER));
//   ASSERT_EQ(kV.symbol(),
//             std::string(SI::KILO_SYMBOL) +
//             std::string(SI::UNIT_SYMBOL_VOLT));
// }
...
//   UnitSP complex_unit = SPU(Unit({{"LENGTH", 2}, {"TIME", -1}, {"MASS",
//   1}}));
//
...
//
//   ASSERT_EQ(km->symbol(), std::string(SI::KILO_SYMBOL) +
//   SI::UNIT_SYMBOL_METER); ASSERT_EQ(km->unit()->scale_factor(), 1000.0);
