...
//   auto control_array = std::make_shared<ControlArray<double>>
//   (control_data);
//
//   Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> measured_data (1,
//   2); measured_data << 3.0, 4.0; auto measured_array
//       = std::make_shared<MeasuredArray<double>> (measured_data);
//
