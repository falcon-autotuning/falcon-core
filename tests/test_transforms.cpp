...
// public:
//     LinearFunction(double slope, double intercept) : _slope(slope),
...
//     std::shared_ptr<AnalyticFunction> func =
//     std::make_shared<DirectorTestFunction>(); PortTransform transform(func);
//
