...
TEST_F(ListLabelledControlArray1DTest, CreateEmpty) {
  ...
  ListLabelledControlArray1D_destroy(nullptr);
...
TEST_F(ListLabelledControlArray1DTest, CreateFromArray) {
  ...
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_create(nullptr, 2);
  EXPECT_EQ(get_last_error_code(), 1);
  ListLabelledControlArray1D_destroy(handle);
}
...
TEST_F(ListLabelledControlArray1DTest, SizeEmptyInvalid) {
  ...
  ListLabelledControlArray1D_destroy(handle);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_size(nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, EmptyInvalid) {
  ...
  ListLabelledControlArray1D_destroy(handle);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_empty(nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, EraseAtClear) {
  ...
  ListLabelledControlArray1D_destroy(handle);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_erase_at(nullptr, 0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_clear(nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, PushBackContainsIndex) {
  ...
  ListLabelledControlArray1D_destroy(handle);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_push_back(nullptr, sh1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_contains(nullptr, sh1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_index(nullptr, sh1);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, ItemsAt) {
  ...
  ListLabelledControlArray1D_destroy(handle);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_items(nullptr, out, 2);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_items(handle, nullptr, 2);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_at(nullptr, 0);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, EqualNotEqualIntersection) {
  ...
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_equal(nullptr, h2);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_equal(h1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_not_equal(h1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_not_equal(nullptr, h2);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_intersection(nullptr, h2);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_intersection(h1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, ToJsonFromJson) {
  ...
  String_destroy(json);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_to_json_string(nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_from_json_string(nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
}

TEST_F(ListLabelledControlArray1DTest, FillValueNull) {
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_fill_value(3, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
}
...
TEST_F(ListLabelledControlArray1DTest, PushBackNull) {
  auto handle = ListLabelledControlArray1D_create_empty();
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_push_back(handle, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  ListLabelledControlArray1D_destroy(handle);
}
...
TEST_F(ListLabelledControlArray1DTest, ContainsNull) {
  auto handle = ListLabelledControlArray1D_create_empty();
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_contains(handle, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  ListLabelledControlArray1D_destroy(handle);
}
...
TEST_F(ListLabelledControlArray1DTest, IndexNull) {
  auto handle = ListLabelledControlArray1D_create_empty();
  set_last_error(0, nullptr);
  ListLabelledControlArray1D_index(handle, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  ListLabelledControlArray1D_destroy(handle);
}
