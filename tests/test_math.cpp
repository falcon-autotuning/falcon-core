...
TEST(QuantityTest, Addition) {
  auto q1   = std::make_shared<Quantity>(10.0, std::make_shared<SymbolUnit>(Meter));
  auto q2   = std::make_shared<Quantity>(5.0, std::make_shared<SymbolUnit>(Meter));
...
TEST(QuantityTest, Multiplication) {
  auto q1 = std::make_shared<Quantity>(10.0, std::make_shared<SymbolUnit>(Meter));
  auto q2 = std::make_shared<Quantity>(5.0, std::make_shared<SymbolUnit>(Second));
...
TEST(QuantityTest, Power) {
  auto q1 = std::make_shared<Quantity>(3.0, std::make_shared<SymbolUnit>(Meter));
