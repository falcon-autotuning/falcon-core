...
TEST(InstrumentInterfacesNamesTest, ExecutionClockSerializationRoundTrip) {
  ...
  ASSERT_EQ(exec_clock2->instrument_type(), falcon_core::INSTRUMENT_TYPES::CLOCK);
...
TEST(InstrumentInterfacesNamesTest, KnobsSerializationRoundTrip) {
  ...
  knobs->push_back(std::make_shared<Knob>("knob1", nullptr, "type1", nullptr, "desc1"));
  knobs->push_back(std::make_shared<Knob>("knob2", nullptr, "type2", nullptr, "desc2"));
...
TEST(InstrumentInterfacesNamesTest, MetersSerializationRoundTrip) {
  ...
  meters->push_back(std::make_shared<Meter>("meter1", nullptr, "type1", nullptr, "desc1"));
  meters->push_back(std::make_shared<Meter>("meter2", nullptr, "type2", nullptr, "desc2"));
