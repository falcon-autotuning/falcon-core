...
TEST_F(FArrayDoubleTest, NullptrCoverage) {
  ...
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_plus_equals_farray(nullptr, arr1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_plus_equals_farray(arr1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_plus_equals_double(nullptr, 1.0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_plus_equals_int(nullptr, 1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ...
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_minus_equals_farray(nullptr, arr1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_minus_equals_farray(arr1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_minus_equals_double(nullptr, 1.0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_minus_equals_int(nullptr, 1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ...
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_times_equals_farray(nullptr, arr1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_times_equals_farray(arr1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_times_equals_double(nullptr, 1.0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_times_equals_int(nullptr, 1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ...
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_divides_equals_farray(nullptr, arr1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_divides_equals_farray(arr1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_divides_equals_double(nullptr, 1.0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_divides_equals_int(nullptr, 1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  ...
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_not_equal(nullptr, arr1);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_not_equal(arr1, nullptr);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_greater_than(nullptr, 1.0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
  FArrayDouble_less_than(nullptr, 1.0);
  EXPECT_EQ(get_last_error_code(), 1);
  set_last_error(0, nullptr);
...
TEST_F(FArrayDoubleTest, ArithmeticAndComparison) {
  ...
  EXPECT_FALSE(FArrayDouble_not_equal(arr1, arr4));
  EXPECT_TRUE(FArrayDouble_greater_than(arr1, -1000.0));
  EXPECT_FALSE(FArrayDouble_less_than(arr1, -1000.0));
  FArrayDouble_plus_equals_farray(arr1, arr4);
  FArrayDouble_plus_equals_double(arr1, 1.0);
  FArrayDouble_plus_equals_int(arr1, 1);
  FArrayDouble_minus_equals_farray(arr1, arr4);
  FArrayDouble_minus_equals_double(arr1, 1.0);
  FArrayDouble_minus_equals_int(arr1, 1);
  FArrayDouble_times_equals_farray(arr1, arr4);
  FArrayDouble_times_equals_double(arr1, 2.0);
  FArrayDouble_times_equals_int(arr1, 2);
  FArrayDouble_divides_equals_farray(arr1, arr4);
  FArrayDouble_divides_equals_double(arr1, 2.0);
  FArrayDouble_divides_equals_int(arr1, 2);
