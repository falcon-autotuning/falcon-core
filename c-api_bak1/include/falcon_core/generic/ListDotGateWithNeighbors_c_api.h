...
/* AUTO-DOC from cpp: ListDotGateWithNeighbors_to_json_string | falcon_core::generic::Song::to_json_string */
/**
...
/* AUTO-DOC from cpp: ListDotGateWithNeighbors_from_json_string | falcon_core::generic::Song::from_json_string */
/**
