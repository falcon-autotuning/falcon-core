...
/**
 * @brief (from C++: falcon_core::math::arrays::LabelledControlArray1D::reshape)
...
/* AUTO-DOC from cpp: LabelledControlArray1D_flip | falcon_core::math::arrays::IsLabelled::flip */
/**
 * @brief (from C++: falcon_core::math::arrays::IsLabelled::flip)
...
size_t LabelledControlArray1D_full_gradient(LabelledControlArray1DHandle handle,
                                            ...
                                            size_t              buffer_size);
/* AUTO-DOC from cpp: LabelledControlArray1D_gradient | falcon_core::math::arrays::IsLabelled::gradient */
/**
 * @brief (from C++: falcon_core::math::arrays::IsLabelled::gradient)
