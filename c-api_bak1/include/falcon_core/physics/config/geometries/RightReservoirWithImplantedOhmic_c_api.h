...
ConnectionHandle RightReservoirWithImplantedOhmic_ohmic(
    RightReservoirWithImplantedOhmicHandle handle);
/* AUTO-DOC from cpp: RightReservoirWithImplantedOhmic_left_neighbor | falcon_core::physics::config::geometries::HasLeftNeighbor::left_neighbor */
/**
 * @brief (from C++: falcon_core::physics::config::geometries::HasLeftNeighbor::left_neighbor)
