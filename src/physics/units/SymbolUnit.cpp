...
SymbolUnit::operator* (const SymbolUnit &other) const
{
  return std::make_shared<SymbolUnit> (*_unit * *other._unit);
}
std::shared_ptr<SymbolUnit>
SymbolUnit::operator* (const Unit &other) const
{
...
std::shared_ptr<SymbolUnit>
SymbolUnit::operator^ (const int power) const
{
  return std::make_shared<SymbolUnit> (*_unit ^ power);
}
std::shared_ptr<SymbolUnit>
SymbolUnit::with_prefix (const std::string prefix) const
{
  return std::make_shared<SymbolUnit> (_unit->with_prefix (prefix));
}
double
SymbolUnit::convert_value_to (
...
bool
SymbolUnit::is_compatible_with (const std::shared_ptr<SymbolUnit> other) const
{
...
std::string
SymbolUnit::_generate_symbol () const
{
...
std::string
SymbolUnit::_get_dimension_symbol (std::string dimension) const
{
...
std::string
SymbolUnit::_generate_name () const
{
