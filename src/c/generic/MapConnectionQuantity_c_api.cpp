...
#include "falcon-core/generic/MapConnectionQuantity_c_api.h"
...
extern "C" {
using MACROMapConnectionHandleQuantityHandle = falcon_core::generic::Map<falcon_core::physics::device_structures::Connection, falcon_core::math::Quantity>;
DEFINE_C_API_COPY_TEMPLATE(MapConnectionQuantity, MACROMapConnectionHandleQuantityHandle)
DEFINE_C_API_DESTROY_TEMPLATE(MapConnectionQuantity, MACROMapConnectionHandleQuantityHandle);
DEFINE_C_API_EQUAL_TEMPLATE(MapConnectionQuantity, MACROMapConnectionHandleQuantityHandle);
DEFINE_C_API_NOT_EQUAL_TEMPLATE(MapConnectionQuantity, MACROMapConnectionHandleQuantityHandle);
DEFINE_C_API_TO_JSON_TEMPLATE(MapConnectionQuantity, MACROMapConnectionHandleQuantityHandle);
DEFINE_C_API_FROM_JSON_TEMPLATE(MapConnectionQuantity, MACROMapConnectionHandleQuantityHandle);
