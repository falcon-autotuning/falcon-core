...
ListAcquisitionContextHandle ListAcquisitionContext_fill_value(size_t count, AcquisitionContextHandle value) {
    ...
    auto stored_obj = *static_cast<std::shared_ptr<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(value);
    
    return new falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>(
        std::make_shared<falcon_core::generic::List<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>>(
            count, stored_obj));
    FALCON_C_API_END(nullptr)
}
...
throw std::invalid_argument("Null data handle passed to ListAcquisitionContext_create");
    ...
    for (size_t i = 0; i < count; ++i) {
        vec.push_back(*static_cast<std::shared_ptr<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(data[i])); 
    }
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_size");
    ...
    return (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->size();
    FALCON_C_API_END(0)
}
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_empty");
    ...
    return (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->empty();
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_erase_at");
    ...
    (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->erase_at(idx);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_clear");
    ...
    (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->clear();
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_push_back");
    ...
    (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->push_back(stored_obj);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_contains");
    ...
    return (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->contains(stored_obj);
    FALCON_C_API_END(false)
}
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_index");
    ...
    return (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->index(stored_obj);
    FALCON_C_API_END(0)
}
...
throw std::invalid_argument("Null output buffer passed to ListAcquisitionContext_items");
    ...
    auto list = *static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle);
    size_t n = std::min(buffer_size, list->items().size());
    
for (size_t i = 0; i < n; ++i) {
    out_buffer[i] = new std::shared_ptr<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>(list->items()[i]);
}
    return n;
    FALCON_C_API_END(0)
}
...
throw std::invalid_argument("Null handle passed to ListAcquisitionContext_at");
    ...
    auto obj = (*static_cast<falcon_core::generic::ListSP<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>*>(handle))->at(idx);
    return new std::shared_ptr<falcon_core::autotuner_interfaces::contexts::AcquisitionContext>(obj);
    FALCON_C_API_END(nullptr)
}
