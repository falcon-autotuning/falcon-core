...
extern "C" {
using MACROListLabelledDomainHandle= falcon_core::generic::List<falcon_core::math::domains::LabelledDomain>;
DEFINE_C_API_COPY_TEMPLATE(ListLabelledDomain, MACROListLabelledDomainHandle)
DEFINE_C_API_DESTROY_TEMPLATE(ListLabelledDomain, MACROListLabelledDomainHandle);
DEFINE_C_API_EQUAL_TEMPLATE(ListLabelledDomain, MACROListLabelledDomainHandle);
DEFINE_C_API_NOT_EQUAL_TEMPLATE(ListLabelledDomain, MACROListLabelledDomainHandle);
DEFINE_C_API_TO_JSON_TEMPLATE(ListLabelledDomain, MACROListLabelledDomainHandle);
DEFINE_C_API_FROM_JSON_TEMPLATE(ListLabelledDomain, MACROListLabelledDomainHandle);
...
throw std::invalid_argument("Null handle passed to ListLabelledDomain_at");
    ...
    return new std::shared_ptr<falcon_core::math::domains::LabelledDomain>(obj);
    FALCON_C_API_END(nullptr)
}
