...
template void falcon_core::math::analytic_functions::AnalyticFunction::serialize<cereal::JSONInputArchive>(cereal::JSONInputArchive&);
template void falcon_core::math::analytic_functions::AnalyticFunction::serialize<cereal::JSONOutputArchive>(cereal::JSONOutputArchive&);
