...
template <typename ArrayType, typename LabelType>
const std::shared_ptr<ArrayType>& BaseLabelledArray<ArrayType, LabelType>::array() const {
  return _array;
}

template <typename ArrayType, typename LabelType>
const std::shared_ptr<LabelType>& BaseLabelledArray<ArrayType, LabelType>::label() const {
  return _label;
}
...
template class falcon_core::math::labelled_arrays::BaseLabelledArray<
    falcon_core::math::arrays::BaseArray<double>, int>;
template void falcon_core::math::labelled_arrays::BaseLabelledArray<
    falcon_core::math::arrays::BaseArray<double>, int>::serialize<cereal::JSONOutputArchive>(cereal::JSONOutputArchive&);
template void falcon_core::math::labelled_arrays::BaseLabelledArray<
    falcon_core::math::arrays::BaseArray<double>, int>::serialize<cereal::JSONInputArchive>(cereal::JSONInputArchive&);
