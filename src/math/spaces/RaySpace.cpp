...
RaySpace::RaySpace(double dr, double dtheta, std::shared_ptr<domains::Domain> domain)
    : UnitSpace(make_axes(dr, dtheta), domain) {}

Axes<discretizers::BaseDiscretizer> RaySpace::make_axes(double dr, double dtheta) {
