...
|  ConnectionHandle | [**Connection\_create\_barrier\_gate**](#function-connection_create_barrier_gate) ([**StringHandle**](structstring.md) name) <br> |
|  ConnectionHandle | [**Connection\_create\_ohmic**](#function-connection_create_ohmic) ([**StringHandle**](structstring.md) name) <br> |
|  ConnectionHandle | [**Connection\_create\_plunger\_gate**](#function-connection_create_plunger_gate) ([**StringHandle**](structstring.md) name) <br> |
|  ConnectionHandle | [**Connection\_create\_reservoir\_gate**](#function-connection_create_reservoir_gate) ([**StringHandle**](structstring.md) name) <br> |
|  ConnectionHandle | [**Connection\_create\_screening\_gate**](#function-connection_create_screening_gate) ([**StringHandle**](structstring.md) name) <br> |
...
|  ConnectionHandle | [**Connection\_from\_json\_string**](#function-connection_from_json_string) ([**StringHandle**](structstring.md) json) <br> |
...
|  [**StringHandle**](structstring.md) | [**Connection\_name**](#function-connection_name) (ConnectionHandle handle) <br>_The name of the connection._  |
|  bool | [**Connection\_not\_equal**](#function-connection_not_equal) (ConnectionHandle handle, ConnectionHandle other) <br> |
|  [**StringHandle**](structstring.md) | [**Connection\_to\_json\_string**](#function-connection_to_json_string) (ConnectionHandle handle) <br> |
|  [**StringHandle**](structstring.md) | [**Connection\_type**](#function-connection_type) (ConnectionHandle handle) <br>_The type of the connection._  |
