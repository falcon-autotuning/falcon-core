...
|  AcquisitionContextHandle | [**AcquisitionContext\_create**](#function-acquisitioncontext_create) (ConnectionHandle connection, [**StringHandle**](structstring.md) instrument\_type, SymbolUnitHandle units) <br> |
...
|  AcquisitionContextHandle | [**AcquisitionContext\_from\_json\_string**](#function-acquisitioncontext_from_json_string) ([**StringHandle**](structstring.md) json) <br> |
|  [**StringHandle**](structstring.md) | [**AcquisitionContext\_instrument\_type**](#function-acquisitioncontext_instrument_type) (AcquisitionContextHandle handle) <br> |
...
|  bool | [**AcquisitionContext\_match\_instrument\_type**](#function-acquisitioncontext_match_instrument_type) (AcquisitionContextHandle handle, [**StringHandle**](structstring.md) other) <br>_Returns if the instrument type matches this context._  |
...
|  [**StringHandle**](structstring.md) | [**AcquisitionContext\_to\_json\_string**](#function-acquisitioncontext_to_json_string) (AcquisitionContextHandle handle) <br> |
