...
|  InstrumentPortHandle | [**Ports\_\_get\_instrument\_type\_matching\_port**](#function-ports__get_instrument_type_matching_port) (PortsHandle handle, [**StringHandle**](structstring.md) insttype) <br>_Check if any port has the given instrument type._  |
...
|  PortsHandle | [**Ports\_from\_json\_string**](#function-ports_from_json_string) ([**StringHandle**](structstring.md) json) <br> |
...
|  [**StringHandle**](structstring.md) | [**Ports\_to\_json\_string**](#function-ports_to_json_string) (PortsHandle handle) <br> |
