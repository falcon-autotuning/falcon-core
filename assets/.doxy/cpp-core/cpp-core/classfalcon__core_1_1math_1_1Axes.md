...
# Class falcon\_core::math::Axes

**template &lt;typename Value&gt;**



[**ClassList**](annotated.md) **>** [**falcon\_core**](namespacefalcon__core.md) **>** [**math**](namespacefalcon__core_1_1math.md) **>** [**Axes**](classfalcon__core_1_1math_1_1Axes.md)



_Container for a collection of axis objects._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
|   | [**Axes**](#function-axes-13) () = default<br> |
|   | [**Axes**](#function-axes-23) (const typename [**generic::List**](classfalcon__core_1_1generic_1_1List.md)&lt; Value &gt;::Container & items) <br>_Construct_ [_**Axes**_](classfalcon__core_1_1math_1_1Axes.md) _from a vector of items._ |
|   | [**Axes**](#function-axes-33) (const generic::ListSP&lt; Value &gt; & items) <br>_Construct_ [_**Axes**_](classfalcon__core_1_1math_1_1Axes.md) _from a vector of items._ |
|  bool | [**operator!=**](#function-operator) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other) const<br> |
|  bool | [**operator==**](#function-operator_1) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|  bool | [**operator\_equal\_impl**](#function-operator_equal_impl-13) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other, [**generic::category::song\_tag**](structfalcon__core_1_1generic_1_1category_1_1song__tag.md)) const<br> |
|  bool | [**operator\_equal\_impl**](#function-operator_equal_impl-23) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other, [**generic::category::primitive\_tag**](structfalcon__core_1_1generic_1_1category_1_1primitive__tag.md)) const<br> |
|  bool | [**operator\_equal\_impl**](#function-operator_equal_impl-33) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other, [**generic::category::other\_tag**](structfalcon__core_1_1generic_1_1category_1_1other__tag.md)) const<br> |
...
[**Axes**](classfalcon__core_1_1math_1_1Axes.md) is a vector-like container for axis objects, such as discretizers or numeric axes. Provides standard vector access methods.
...
* `T` The type of axis object (e.g., double, BaseDiscretizer). 
...
```C++
falcon_core::math::Axes::Axes () = default
```
...
_Construct_ [_**Axes**_](classfalcon__core_1_1math_1_1Axes.md) _from a vector of items._
```C++
inline explicit falcon_core::math::Axes::Axes (
    const typename generic::List < Value >::Container & items
) 
```
...
* `items` [**Vector**](classfalcon__core_1_1math_1_1Vector.md) of axis objects. 
...
```C++
inline bool falcon_core::math::Axes::operator!= (
    const Axes < Value > & other
) const
```
...
```C++
inline bool falcon_core::math::Axes::operator_equal_impl (
    const Axes < Value > & other,
    generic::category::song_tag
) const
```
...
inline bool falcon_core::math::Axes::operator_equal_impl (
    const Axes < Value > & other,
    generic::category::primitive_tag
) const
```
...
------------------------------
The documentation for this class was generated from the following file `cpp/include/falcon_core/math/Axes.hpp`
