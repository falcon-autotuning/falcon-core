...
| Type | Name |
| ---: | :--- |
|   | [**LabelledDomain**](#function-labelleddomain-13) (const [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) & other) <br> |
...
|  std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**domain**](#function-domain) () const<br>_Gets the domain associated with the port._  |
...
|  bool | [**operator!=**](#function-operator) (const [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) & other) const<br> |
|  [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) & | [**operator=**](#function-operator_1) (const [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|   | [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-domain-14) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) <br> |
...
|  const std::pair&lt; double, double &gt; | [**calculate\_transform**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-calculate_transform) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Calculate the linear transformation parameters to map this domain to another domain._  |
|  const bool | [**contains\_domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-contains_domain) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Check if this domain completely contains another domain._  |
...
|  bool | [**operator!=**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-operator) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) const<br> |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**operator&**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-operator_1) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Get the intersection of this domain with another domain._  |
|  [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & | [**operator=**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-operator_2) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) <br> |
|  bool | [**operator==**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-operator_3) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) const<br> |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**operator\|**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-operator_4) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Get the union of this domain with another domain._  |
...
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**scale**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-scale) (double factor) const<br>_Scale the domain by a factor._  |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**shift**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-shift) (double offset) const<br>_Shift the domain by an offset._  |
|  const double | [**transform**](classfalcon__core_1_1math_1_1domains_1_1Domain.md#function-transform) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other, double value) const<br>_Transform a value from this domain to another domain._  |
...
| Type | Name |
| ---: | :--- |
|  const std::shared\_ptr&lt; [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) &gt; | [**from\_domain**](#function-from_domain) (const DomainSP & domain, const std::string & default\_name, const physics::device\_structures::ConnectionSP & pseudo\_name, const instrument\_interfaces::names::Instrument & instrument\_type, const physics::units::SymbolUnitSP & units=[**physics::units::SymbolUnit::Volt**](classfalcon__core_1_1physics_1_1units_1_1SymbolUnit.md#function-volt)(), const std::string & description="") <br>_Create a_ [_**LabelledDomain**_](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) _from an existing domain._ |
|  const std::shared\_ptr&lt; [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) &gt; | [**from\_port**](#function-from_port) (const std::pair&lt; double, double &gt; & bounds, const instrument\_interfaces::names::InstrumentPortSP & port, const bool & lesser\_bound\_contained=true, const bool & greater\_bound\_contained=true) <br>_Construct a labelled domain._  |
|  const std::shared\_ptr&lt; [**LabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) &gt; | [**from\_port\_and\_domain**](#function-from_port_and_domain) (const instrument\_interfaces::names::InstrumentPortSP & port, const DomainSP & domain) <br>_Create a_ [_**LabelledDomain**_](classfalcon__core_1_1math_1_1domains_1_1LabelledDomain.md) _from an existing knob and domain._ |
