...
```C++
using falcon_core::instrument_interfaces::names::Instrument = typedef std::string;
```
...
```C++
using falcon_core::instrument_interfaces::names::InstrumentPortSP = typedef std::shared_ptr<InstrumentPort>;
```
...
```C++
using falcon_core::instrument_interfaces::names::PortsSP = typedef std::shared_ptr<Ports>;
```
