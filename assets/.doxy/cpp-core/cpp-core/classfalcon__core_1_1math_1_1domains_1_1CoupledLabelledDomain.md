...
# Class falcon\_core::math::domains::CoupledLabelledDomain



[**ClassList**](annotated.md) **>** [**falcon\_core**](namespacefalcon__core.md) **>** [**math**](namespacefalcon__core_1_1math.md) **>** [**domains**](namespacefalcon__core_1_1math_1_1domains.md) **>** [**CoupledLabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1CoupledLabelledDomain.md)



_A collection of coupled domains to be attached together._ 

* `#include <CoupledLabelledDomain.hpp>`
...
| Type | Name |
| ---: | :--- |
|   | [**CoupledLabelledDomain**](#function-coupledlabelleddomain-12) () <br> |
|   | [**CoupledLabelledDomain**](#function-coupledlabelleddomain-22) (const std::vector&lt; LabelledDomainSP &gt; & init) <br>_Construct from a vector of labelled domains._  |
|  const std::vector&lt; LabelledDomainSP &gt; | [**domains**](#function-domains) () const<br>_Get all domains._  |
|  LabelledDomainSP | [**get\_domain**](#function-get_domain) (const instrument\_interfaces::names::InstrumentPortSP & search) const<br>_Get domain by label._  |
|  const instrument\_interfaces::names::PortsSP | [**labels**](#function-labels) () const<br>_Get all labels._  |
|  bool | [**operator!=**](#function-operator) (const [**CoupledLabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1CoupledLabelledDomain.md) & other) const<br> |
|  bool | [**operator==**](#function-operator_1) (const [**CoupledLabelledDomain**](classfalcon__core_1_1math_1_1domains_1_1CoupledLabelledDomain.md) & other) const<br> |
...
### function CoupledLabelledDomain [1/2]

```C++
falcon_core::math::domains::CoupledLabelledDomain::CoupledLabelledDomain () 
```
...
### function CoupledLabelledDomain [2/2]

_Construct from a vector of labelled domains._ 
```C++
falcon_core::math::domains::CoupledLabelledDomain::CoupledLabelledDomain (
...
* `domains` [**Vector**](classfalcon__core_1_1math_1_1Vector.md) of shared pointers to labelled domains. 
...
_Get all domains._ 
```C++
const std::vector< LabelledDomainSP > falcon_core::math::domains::CoupledLabelledDomain::domains () const
```
...
```C++
LabelledDomainSP falcon_core::math::domains::CoupledLabelledDomain::get_domain (
    const instrument_interfaces::names::InstrumentPortSP & search
) const
```
...
_Get all labels._ 
```C++
const instrument_interfaces::names::PortsSP falcon_core::math::domains::CoupledLabelledDomain::labels () const
```
...
[**Vector**](classfalcon__core_1_1math_1_1Vector.md) of shared pointers to labels. 
...
```C++
bool falcon_core::math::domains::CoupledLabelledDomain::operator!= (
    const CoupledLabelledDomain & other
) const
```
...
------------------------------
The documentation for this class was generated from the following file `cpp/include/falcon_core/math/domains/CoupledLabelledDomain.hpp`
