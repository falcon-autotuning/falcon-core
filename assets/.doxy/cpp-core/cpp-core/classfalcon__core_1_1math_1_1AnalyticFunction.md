...
| Type | Name |
| ---: | :--- |
|   | [**AnalyticFunction**](#function-analyticfunction-13) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) <br> |
...
|  bool | [**operator!=**](#function-operator) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) const<br> |
|  [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & | [**operator=**](#function-operator_1) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) &gt; | [**Constant**](#function-constant) (const double & value) <br>_Construct an constant function. The equation is : const where const is supplied here on construction._  |
|  std::shared\_ptr&lt; [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) &gt; | [**Identity**](#function-identity) () <br>_Construct an identity. The equation is : x[0] where x[0] is some supplied quantity._  |
