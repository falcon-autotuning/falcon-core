...
# Class falcon\_core::communications::voltage\_states::DeviceVoltageStates



[**ClassList**](annotated.md) **>** [**falcon\_core**](namespacefalcon__core.md) **>** [**communications**](namespacefalcon__core_1_1communications.md) **>** [**voltage\_states**](namespacefalcon__core_1_1communications_1_1voltage__states.md) **>** [**DeviceVoltageStates**](classfalcon__core_1_1communications_1_1voltage__states_1_1DeviceVoltageStates.md)
...
| Type | Name |
| ---: | :--- |
|   | [**DeviceVoltageStates**](#function-devicevoltagestates-12) () <br> |
|   | [**DeviceVoltageStates**](#function-devicevoltagestates-22) (const generic::ListSP&lt; [**DeviceVoltageState**](classfalcon__core_1_1communications_1_1voltage__states_1_1DeviceVoltageState.md) &gt; & states) <br>_Initialize a set of_ [_**DeviceVoltageStates**_](classfalcon__core_1_1communications_1_1voltage__states_1_1DeviceVoltageStates.md) _._ |
|  void | [**add\_state**](#function-add_state) (const DeviceVoltageStateSP & state) <br>_Add a voltage state to the collection._  |
|  const DeviceVoltageStateSP | [**find\_state**](#function-find_state) (const physics::device\_structures::ConnectionSP & connection) const<br>_Find a voltage state by its connection._  |
|  const generic::ListSP&lt; [**DeviceVoltageState**](classfalcon__core_1_1communications_1_1voltage__states_1_1DeviceVoltageState.md) &gt; | [**states**](#function-states) () const<br>_Returns the list of voltage states._  |
|  const math::PointSP | [**to\_point**](#function-to_point) () const<br>_Conversion to the Point datatype._  |
...
### function DeviceVoltageStates [1/2]

```C++
falcon_core::communications::voltage_states::DeviceVoltageStates::DeviceVoltageStates () 
```
...
### function DeviceVoltageStates [2/2]

_Initialize a set of_ [_**DeviceVoltageStates**_](classfalcon__core_1_1communications_1_1voltage__states_1_1DeviceVoltageStates.md) _._
```C++
falcon_core::communications::voltage_states::DeviceVoltageStates::DeviceVoltageStates (
...
* `states` all of the states contained within the DeviceVotlageStates. 
...
```C++
void falcon_core::communications::voltage_states::DeviceVoltageStates::add_state (
    const DeviceVoltageStateSP & state
) 
```
...
```C++
const DeviceVoltageStateSP falcon_core::communications::voltage_states::DeviceVoltageStates::find_state (
...
```C++
const generic::ListSP< DeviceVoltageState > falcon_core::communications::voltage_states::DeviceVoltageStates::states () const
```
...
```C++
const math::PointSP falcon_core::communications::voltage_states::DeviceVoltageStates::to_point () const
```
...
------------------------------
The documentation for this class was generated from the following file `cpp/include/falcon_core/communications/voltage_states/DeviceVoltageStates.hpp`
