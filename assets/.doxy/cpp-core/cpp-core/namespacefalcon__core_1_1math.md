...
```C++
using falcon_core::math::AnalyticFunctionSP = typedef std::shared_ptr<AnalyticFunction>;
```
...
```C++
using falcon_core::math::AxesSP = typedef std::shared_ptr<Axes<V> >;
```
...
```C++
using falcon_core::math::PointSP = typedef std::shared_ptr<Point>;
```
...
```C++
using falcon_core::math::QuantitySP = typedef std::shared_ptr<Quantity>;
```
...
```C++
using falcon_core::math::UnitSpaceSP = typedef std::shared_ptr<UnitSpace>;
```
...
```C++
using falcon_core::math::VariableName = typedef std::string;
```
...
```C++
using falcon_core::math::VectorSP = typedef std::shared_ptr<Vector>;
```
