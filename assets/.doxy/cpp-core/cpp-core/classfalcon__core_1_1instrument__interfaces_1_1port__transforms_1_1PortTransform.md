...
| Type | Name |
| ---: | :--- |
|   | [**PortTransform**](#function-porttransform-13) (const [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) & other) <br> |
...
|  bool | [**operator!=**](#function-operator) (const [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) & other) const<br> |
|  [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) & | [**operator=**](#function-operator_1) (const [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|   | [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md#function-analyticfunction-13) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) <br> |
...
|  bool | [**operator!=**](classfalcon__core_1_1math_1_1AnalyticFunction.md#function-operator) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) const<br> |
|  [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & | [**operator=**](classfalcon__core_1_1math_1_1AnalyticFunction.md#function-operator_1) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) <br> |
|  bool | [**operator==**](classfalcon__core_1_1math_1_1AnalyticFunction.md#function-operator_2) (const [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) &gt; | [**ConstantTransform**](#function-constanttransform) (const names::InstrumentPortSP & port, const double & value) <br>_Construct a constant transform attached to a specific port._  |
|  std::shared\_ptr&lt; [**PortTransform**](classfalcon__core_1_1instrument__interfaces_1_1port__transforms_1_1PortTransform.md) &gt; | [**IdentityTransform**](#function-identitytransform) (const names::InstrumentPortSP & port) <br>_Construct an identity transform attached to a specific port._  |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) &gt; | [**Constant**](classfalcon__core_1_1math_1_1AnalyticFunction.md#function-constant) (const double & value) <br>_Construct an constant function. The equation is : const where const is supplied here on construction._  |
|  std::shared\_ptr&lt; [**AnalyticFunction**](classfalcon__core_1_1math_1_1AnalyticFunction.md) &gt; | [**Identity**](classfalcon__core_1_1math_1_1AnalyticFunction.md#function-identity) () <br>_Construct an identity. The equation is : x[0] where x[0] is some supplied quantity._  |
