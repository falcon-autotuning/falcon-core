...
```C++
using falcon_core::physics::device_structures::ConnectionSP = typedef std::shared_ptr<Connection>;
```
...
```C++
using falcon_core::physics::device_structures::ConnectionsSP = typedef std::shared_ptr<Connections>;
```
...
```C++
using falcon_core::physics::device_structures::GateRelationsSP = typedef std::shared_ptr<GateRelations>;
```
...
```C++
using falcon_core::physics::device_structures::ImpedanceSP = typedef std::shared_ptr<Impedance>;
```
...
```C++
using falcon_core::physics::device_structures::ImpedancesSP = typedef std::shared_ptr<Impedances>;
```
