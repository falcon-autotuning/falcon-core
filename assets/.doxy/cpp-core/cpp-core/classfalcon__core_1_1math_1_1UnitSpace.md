...
| Type | Name |
| ---: | :--- |
|   | [**UnitSpace**](#function-unitspace-13) (const [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) & other) <br> |
...
|  bool | [**operator!=**](#function-operator) (const [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) & other) const<br> |
|  [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) & | [**operator=**](#function-operator_1) (const [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) & other) <br> |
|  bool | [**operator==**](#function-operator_2) (const [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) & other) const<br> |
...
|  bool | [**operator!=**](classfalcon__core_1_1math_1_1Axes.md#function-operator) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other) const<br> |
|  bool | [**operator==**](classfalcon__core_1_1math_1_1Axes.md#function-operator_1) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other) const<br> |
...
| Type | Name |
| ---: | :--- |
|  std::shared\_ptr&lt; [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) &gt; | [**Cartesian1DSpace**](#function-cartesian1dspace) (const double & delta, const domains::DomainSP & domain) <br>_Create a 1D cartesian space._  |
|  std::shared\_ptr&lt; [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) &gt; | [**Cartesian2DSpace**](#function-cartesian2dspace) (const AxesSP&lt; double &gt; & deltas, const domains::DomainSP & domain) <br>_Create a 2D cartesian space._  |
|  std::shared\_ptr&lt; [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) &gt; | [**CartesianSpace**](#function-cartesianspace) (const AxesSP&lt; double &gt; & deltas, const domains::DomainSP & domain) <br>_Create a ND cartesian space._  |
|  std::shared\_ptr&lt; [**UnitSpace**](classfalcon__core_1_1math_1_1UnitSpace.md) &gt; | [**RaySpace**](#function-rayspace) (const double & dr, const double & dtheta, const domains::DomainSP & domain) <br>_Create a ray space with radial and angular discretization._  |
...
| Type | Name |
| ---: | :--- |
|  bool | [**operator\_equal\_impl**](classfalcon__core_1_1math_1_1Axes.md#function-operator_equal_impl-13) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other, [**generic::category::song\_tag**](structfalcon__core_1_1generic_1_1category_1_1song__tag.md)) const<br> |
|  bool | [**operator\_equal\_impl**](classfalcon__core_1_1math_1_1Axes.md#function-operator_equal_impl-23) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other, [**generic::category::primitive\_tag**](structfalcon__core_1_1generic_1_1category_1_1primitive__tag.md)) const<br> |
|  bool | [**operator\_equal\_impl**](classfalcon__core_1_1math_1_1Axes.md#function-operator_equal_impl-33) (const [**Axes**](classfalcon__core_1_1math_1_1Axes.md)&lt; Value &gt; & other, [**generic::category::other\_tag**](structfalcon__core_1_1generic_1_1category_1_1other__tag.md)) const<br> |
