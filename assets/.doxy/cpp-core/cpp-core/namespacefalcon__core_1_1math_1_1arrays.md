...
```C++
using falcon_core::math::arrays::ControlArray1DSP = typedef std::shared_ptr<ControlArray1D>;
```
...
```C++
using falcon_core::math::arrays::ControlArraySP = typedef std::shared_ptr<ControlArray>;
```
...
```C++
using falcon_core::math::arrays::IncreasingAlignmentSP = typedef std::shared_ptr<IncreasingAlignment>;
```
...
```C++
using falcon_core::math::arrays::LabelledArraysSP = typedef std::shared_ptr<LabelledArrays<T> >;
```
...
```C++
using falcon_core::math::arrays::LabelledControlArray1DSP = typedef std::shared_ptr<LabelledControlArray1D>;
```
...
```C++
using falcon_core::math::arrays::LabelledControlArraySP = typedef std::shared_ptr<LabelledControlArray>;
```
...
```C++
using falcon_core::math::arrays::LabelledMeasuredArray1DSP = typedef std::shared_ptr<LabelledMeasuredArray1D>;
```
...
```C++
using falcon_core::math::arrays::LabelledMeasuredArraySP = typedef std::shared_ptr<LabelledMeasuredArray>;
```
...
```C++
using falcon_core::math::arrays::MeasuredArray1DSP = typedef std::shared_ptr<MeasuredArray1D>;
```
...
```C++
using falcon_core::math::arrays::MeasuredArraySP = typedef std::shared_ptr<MeasuredArray>;
```
