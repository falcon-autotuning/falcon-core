...
# Class falcon\_core::physics::device\_structures::Impedances



[**ClassList**](annotated.md) **>** [**falcon\_core**](namespacefalcon__core.md) **>** [**physics**](namespacefalcon__core_1_1physics.md) **>** [**device\_structures**](namespacefalcon__core_1_1physics_1_1device__structures.md) **>** [**Impedances**](classfalcon__core_1_1physics_1_1device__structures_1_1Impedances.md)



_A collection of_ [_**Impedances**_](classfalcon__core_1_1physics_1_1device__structures_1_1Impedances.md) _._

* `#include <Impedances.hpp>`
...
| Type | Name |
| ---: | :--- |
|   | [**Impedances**](#function-impedances-12) () <br> |
|   | [**Impedances**](#function-impedances-22) (const std::vector&lt; ImpedanceSP &gt; & vec) <br> |
|  bool | [**operator!=**](#function-operator) (const [**Impedances**](classfalcon__core_1_1physics_1_1device__structures_1_1Impedances.md) & other) const<br> |
|  bool | [**operator==**](#function-operator_1) (const [**Impedances**](classfalcon__core_1_1physics_1_1device__structures_1_1Impedances.md) & other) const<br> |
...
### function Impedances [1/2]

```C++
falcon_core::physics::device_structures::Impedances::Impedances () 
```
...
### function Impedances [2/2]

```C++
falcon_core::physics::device_structures::Impedances::Impedances (
    const std::vector< ImpedanceSP > & vec
) 
```
...
```C++
bool falcon_core::physics::device_structures::Impedances::operator!= (
    const Impedances & other
) const
```
...
------------------------------
The documentation for this class was generated from the following file `cpp/include/falcon_core/physics/device_structures/Impedances.hpp`
