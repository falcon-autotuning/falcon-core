...
```C++
using falcon_core::autotuner_interfaces::interpretations::InterpretationContainerSP = typedef std::shared_ptr<InterpretationContainer<Value> >;
```
...
```C++
using falcon_core::autotuner_interfaces::interpretations::InterpretationContextSP = typedef std::shared_ptr<InterpretationContext>;
```
