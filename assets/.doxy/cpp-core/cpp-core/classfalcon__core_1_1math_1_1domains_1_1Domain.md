...
| Type | Name |
| ---: | :--- |
|   | [**Domain**](#function-domain-14) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) <br> |
...
|  const std::pair&lt; double, double &gt; | [**calculate\_transform**](#function-calculate_transform) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Calculate the linear transformation parameters to map this domain to another domain._  |
|  const bool | [**contains\_domain**](#function-contains_domain) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Check if this domain completely contains another domain._  |
...
|  bool | [**operator!=**](#function-operator) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) const<br> |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**operator&**](#function-operator_1) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Get the intersection of this domain with another domain._  |
|  [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & | [**operator=**](#function-operator_2) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) <br> |
|  bool | [**operator==**](#function-operator_3) (const [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) & other) const<br> |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**operator\|**](#function-operator_4) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other) const<br>_Get the union of this domain with another domain._  |
|  const double | [**range**](#function-range) () const<br>_Get the size of the domain._  |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**scale**](#function-scale) (double factor) const<br>_Scale the domain by a factor._  |
|  const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; | [**shift**](#function-shift) (double offset) const<br>_Shift the domain by an offset._  |
|  const double | [**transform**](#function-transform) (const std::shared\_ptr&lt; [**Domain**](classfalcon__core_1_1math_1_1domains_1_1Domain.md) &gt; & other, double value) const<br>_Transform a value from this domain to another domain._  |
