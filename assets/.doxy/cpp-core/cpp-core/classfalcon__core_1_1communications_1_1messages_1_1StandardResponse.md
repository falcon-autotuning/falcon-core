...
# Class falcon\_core::communications::messages::StandardResponse



[**ClassList**](annotated.md) **>** [**falcon\_core**](namespacefalcon__core.md) **>** [**communications**](namespacefalcon__core_1_1communications.md) **>** [**messages**](namespacefalcon__core_1_1communications_1_1messages.md) **>** [**StandardResponse**](classfalcon__core_1_1communications_1_1messages_1_1StandardResponse.md)
...
| Type | Name |
| ---: | :--- |
|   | [**StandardResponse**](#function-standardresponse-12) (const std::string & message) <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**StandardResponse**](#function-standardresponse-22) () <br> |
...
### function StandardResponse [1/2]

```C++
falcon_core::communications::messages::StandardResponse::StandardResponse (
...
inline void falcon_core::communications::messages::StandardResponse::serialize (
    Archive & ar
) 
```
...
```C++
class falcon_core::communications::messages::StandardResponse::access (
    cereal::access
) 
```
...
------------------------------
The documentation for this class was generated from the following file `cpp/include/falcon_core/communications/messages/StandardResponse.hpp`
