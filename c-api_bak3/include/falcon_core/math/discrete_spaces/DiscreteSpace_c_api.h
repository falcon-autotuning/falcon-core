...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::space)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::axes)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::increasing)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::knobs)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::validate_unit_space_dimensionality_matches_knobs)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::validate_knob_uniqueness)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::get_axis)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::get_domain)
...
/**
 * @brief (from C++: falcon_core::math::discrete_spaces::DiscreteSpace::get_projection)
