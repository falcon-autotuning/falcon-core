...
//     auto item1 = InstrumentPort_create_port(String_wrap("port1"));
//     auto item2 = InstrumentPort_create_port(String_wrap("port2"));
...
//   }
//   void TearDown() override { AxesInstrumentPort_destroy(axes); }
//
...
//
//   InstrumentPortHandle out[4];
//
//   out[0]  = InstrumentPort_create_port(String_wrap("port1"));
//   auto h2 = AxesInstrumentPort_create_raw(out, 2);
//
//   AxesInstrumentPort_push_back(
//       axes, InstrumentPort_create_port(String_wrap("port1")));
//   InstrumentPortHandle out2[2];
//   AxesInstrumentPort_items(axes, out2, 2);
...
//   EXPECT_THROW(AxesInstrumentPort_equal(axes, nullptr),
//   std::invalid_argument); EXPECT_THROW(AxesInstrumentPort_not_equal(nullptr,
//   axes2),
//                std::invalid_argument);
...
//   EXPECT_THROW(AxesInstrumentPort_erase_at(nullptr, 0),
//   std::invalid_argument); EXPECT_THROW(AxesInstrumentPort_clear(nullptr),
//   std::invalid_argument); EXPECT_THROW(AxesInstrumentPort_push_back(nullptr,
//   0), std::invalid_argument);
//   EXPECT_THROW(AxesInstrumentPort_contains(nullptr, 0),
//   std::invalid_argument); EXPECT_THROW(AxesInstrumentPort_contains(axes,
//   nullptr),
//                std::invalid_argument);
//   EXPECT_THROW(AxesInstrumentPort_index(nullptr, 0), std::invalid_argument);
//   EXPECT_THROW(AxesInstrumentPort_index(axes, nullptr),
//   std::invalid_argument); EXPECT_THROW(AxesInstrumentPort_items(nullptr,
//   rawbuffer, 2),
//                std::invalid_argument);
