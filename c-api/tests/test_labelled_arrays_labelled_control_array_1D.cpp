...
TEST_F(LabelledArraysLabelledControlArray1DTest, CreateDestroy) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_create(nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_destroy(nullptr),
               std::invalid_argument);
}
...
TEST_F(LabelledArraysLabelledControlArray1DTest, Accessors) {
  ...
  EXPECT_TRUE(LabelledArraysLabelledControlArray1D_isControlArrays(arrays));
  EXPECT_FALSE(LabelledArraysLabelledControlArray1D_isMeasuredArrays(arrays));

  EXPECT_THROW(LabelledArraysLabelledControlArray1D_arrays(nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_labels(nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_isControlArrays(nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_isMeasuredArrays(nullptr),
               std::invalid_argument);
}
...
TEST_F(LabelledArraysLabelledControlArray1DTest, AtAndSizeEmpty) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_at(nullptr, 0),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_size(nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_empty(nullptr),
               std::invalid_argument);
}
...
TEST_F(LabelledArraysLabelledControlArray1DTest, EraseClearPushBack) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_push_back(nullptr, arr1),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_push_back(arrays, nullptr),
               std::invalid_argument);

  LabelledArraysLabelledControlArray1D_erase_at(arrays, 2);
  EXPECT_EQ(LabelledArraysLabelledControlArray1D_size(arrays), 2);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_erase_at(nullptr, 0),
               std::invalid_argument);
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_clear(nullptr),
               std::invalid_argument);
}
...
TEST_F(LabelledArraysLabelledControlArray1DTest, ContainsIndex) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_contains(nullptr, arr1),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_contains(arrays, nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_index(nullptr, arr1),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_index(arrays, nullptr),
               std::invalid_argument);
}
...
TEST_F(LabelledArraysLabelledControlArray1DTest, Equality) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_equal(nullptr, a2),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_equal(arrays, nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_not_equal(nullptr, a2),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_not_equal(arrays, nullptr),
               std::invalid_argument);
...
TEST_F(LabelledArraysLabelledControlArray1DTest, Intersection) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_intersection(nullptr, a2),
               std::invalid_argument);
  EXPECT_THROW(
...
TEST_F(LabelledArraysLabelledControlArray1DTest, ToJsonFromJson) {
  ...
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_to_json_string(nullptr),
               std::invalid_argument);
  EXPECT_THROW(LabelledArraysLabelledControlArray1D_from_json_string(nullptr),
               std::invalid_argument);
}
