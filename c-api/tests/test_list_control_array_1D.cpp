...
TEST_F(ListControlArray1DTest, CreateEmpty) {
  ...
  EXPECT_THROW(ListControlArray1D_destroy(nullptr), std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, CreateFromArray) {
  ...
  EXPECT_THROW(ListControlArray1D_create(nullptr, 2), std::invalid_argument);
  ListControlArray1D_destroy(handle);
}
...
TEST_F(ListControlArray1DTest, SizeEmptyInvalid) {
  ...
  EXPECT_EQ(ListControlArray1D_size(handle), 0);
  ListControlArray1D_destroy(handle);
  EXPECT_THROW(ListControlArray1D_size(nullptr), std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, EmptyInvalid) {
  ...
  EXPECT_TRUE(ListControlArray1D_empty(handle));
  ListControlArray1D_destroy(handle);
  EXPECT_THROW(ListControlArray1D_empty(nullptr), std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, EraseAtClear) {
  ...
  EXPECT_TRUE(ListControlArray1D_empty(handle));
  ListControlArray1D_destroy(handle);
  EXPECT_THROW(ListControlArray1D_erase_at(nullptr, 0), std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_clear(nullptr), std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, PushBackContainsIndex) {
  ...
  ListControlArray1D_destroy(handle);
  EXPECT_THROW(ListControlArray1D_push_back(nullptr, sh1),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_contains(nullptr, sh1),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_index(nullptr, sh1), std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, ItemsAt) {
  ...
  ListControlArray1D_destroy(handle);
  EXPECT_THROW(ListControlArray1D_items(nullptr, out, 2),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_items(handle, nullptr, 2),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_at(nullptr, 0), std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, EqualNotEqualIntersection) {
  ...
  EXPECT_THROW(ListControlArray1D_equal(nullptr, h2), std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_equal(h1, nullptr), std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_not_equal(h1, nullptr),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_not_equal(nullptr, h2),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_intersection(nullptr, h2),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_intersection(h1, nullptr),
               std::invalid_argument);
}
...
TEST_F(ListControlArray1DTest, ToJsonFromJson) {
  ...
  String_destroy(json);
  EXPECT_THROW(ListControlArray1D_to_json_string(nullptr),
               std::invalid_argument);
  EXPECT_THROW(ListControlArray1D_from_json_string(nullptr),
               std::invalid_argument);
}

TEST_F(ListControlArray1DTest, FillValueNull) {
  EXPECT_THROW(ListControlArray1D_fill_value(3, nullptr),
               std::invalid_argument);
}

TEST_F(ListControlArray1DTest, PushBackNull) {
  auto handle = ListControlArray1D_create_empty();
  EXPECT_THROW(ListControlArray1D_push_back(handle, nullptr),
               std::invalid_argument);
  ListControlArray1D_destroy(handle);
}
...
TEST_F(ListControlArray1DTest, ContainsNull) {
  auto handle = ListControlArray1D_create_empty();
  EXPECT_THROW(ListControlArray1D_contains(handle, nullptr),
               std::invalid_argument);
  ListControlArray1D_destroy(handle);
}
...
TEST_F(ListControlArray1DTest, IndexNull) {
  auto handle = ListControlArray1D_create_empty();
  EXPECT_THROW(ListControlArray1D_index(handle, nullptr),
               std::invalid_argument);
  ListControlArray1D_destroy(handle);
}
