...
throw std::invalid_argument("Null map handle passed to InterpretationContainerString_destroy");
    ...
    delete static_cast<falcon_core::autotuner_interfaces::interpretations::InterpretationContainerSP<std::string>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to InterpretationContainerString_equal");
    ...
    auto listA = *static_cast<falcon_core::autotuner_interfaces::interpretations::InterpretationContainerSP<std::string>*>(handle);
    auto listB = *static_cast<falcon_core::autotuner_interfaces::interpretations::InterpretationContainerSP<std::string>*>(other);
    return *listA == *listB;
    FALCON_C_API_END(false)
}
...
std::string json = (*static_cast<falcon_core::autotuner_interfaces::interpretations::InterpretationContainerSP<std::string>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to InterpretationContainerString_from_json_string");
  ...
  return new falcon_core::autotuner_interfaces::interpretations::InterpretationContainerSP<std::string>(ptr);
    FALCON_C_API_END(nullptr)
}
}
