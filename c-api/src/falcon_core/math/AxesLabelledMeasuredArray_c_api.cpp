...
throw std::invalid_argument("Null handle passed to AxesLabelledMeasuredArray_destroy");
    ...
    delete static_cast<falcon_core::math::AxesSP<falcon_core::math::arrays::LabelledMeasuredArray>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to AxesLabelledMeasuredArray_at");
    ...
    return new falcon_core::math::arrays::LabelledMeasuredArraySP(obj);
    FALCON_C_API_END(nullptr)
}
...
throw std::invalid_argument("Null handle passed to AxesLabelledMeasuredArray_to_json_string");
    ...
    std::string json = (*static_cast<falcon_core::math::AxesSP<falcon_core::math::arrays::LabelledMeasuredArray>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to AxesLabelledMeasuredArray_from_json_string");
  ...
  return new falcon_core::math::AxesSP<falcon_core::math::arrays::LabelledMeasuredArray>(ptr);
    FALCON_C_API_END(nullptr)
}
}
