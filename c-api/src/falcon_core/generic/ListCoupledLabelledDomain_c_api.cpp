...
void ListCoupledLabelledDomain_destroy(ListCoupledLabelledDomainHandle handle) {
    ...
    delete static_cast<falcon_core::generic::ListSP<falcon_core::math::domains::CoupledLabelledDomain>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to ListCoupledLabelledDomain_to_json_string");
    ...
    std::string json = (*static_cast<falcon_core::generic::ListSP<falcon_core::math::domains::CoupledLabelledDomain>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to ListCoupledLabelledDomain_from_json_string");
  ...
  return new falcon_core::generic::ListSP<falcon_core::math::domains::CoupledLabelledDomain>(ptr);
    FALCON_C_API_END(nullptr)
}
}
