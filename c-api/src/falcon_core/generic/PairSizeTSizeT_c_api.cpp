...
throw std::invalid_argument("Null handle passed to PairSizeTSizeT_destroy");
    ...
    delete static_cast<falcon_core::generic::PairSP<size_t, size_t>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to PairSizeTSizeT_equal");
    ...
    auto pair_a = *static_cast<falcon_core::generic::PairSP<size_t, size_t>*>(handle);
    auto pair_b = *static_cast<falcon_core::generic::PairSP<size_t, size_t>*>(other);
...
std::string json = (*static_cast<falcon_core::generic::PairSP<size_t,size_t>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to PairSizeTSizeT_from_json_string");
  ...
  return new falcon_core::generic::PairSP<size_t,size_t>(ptr);
    FALCON_C_API_END(nullptr)
}
}
