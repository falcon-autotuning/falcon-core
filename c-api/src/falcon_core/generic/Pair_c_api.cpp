...
PairConnectionConnectionHandle PairConnectionConnection_create(
    ConnectionHandle first, ConnectionHandle second) {
  auto first_obj =
  ...
  auto second_obj =
      static_cast<falcon_core::physics::device_structures::ConnectionSP*>(
          second);
  return new Pair<falcon_core::physics::device_structures::Connection,
...
void PairConnectionConnection_destroy(PairConnectionConnectionHandle handle) {
  delete static_cast<
      Pair<falcon_core::physics::device_structures::Connection,
           falcon_core::physics::device_structures::Connection>*>(handle);
}

ConnectionHandle PairConnectionConnection_first(
    PairConnectionConnectionHandle handle) {
  auto pair =
      static_cast<Pair<falcon_core::physics::device_structures::Connection,
                       falcon_core::physics::device_structures::Connection>*>(
          handle);
...
bool PairConnectionConnection_equal(PairConnectionConnectionHandle a,
                                    PairConnectionConnectionHandle b) {
  auto pair_a =
      static_cast<Pair<falcon_core::physics::device_structures::Connection,
                       falcon_core::physics::device_structures::Connection>*>(
          a);
