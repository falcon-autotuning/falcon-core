...
ListIntHandle ListInt_create_empty() {
    return new std::shared_ptr<falcon_core::generic::List<int>>(
        std::make_shared<falcon_core::generic::List<int>>());
}

ListIntHandle ListInt_allocate(size_t count) {
    return new std::shared_ptr<falcon_core::generic::List<int>>(
        std::make_shared<falcon_core::generic::List<int>>(count));
}

ListIntHandle ListInt_fill_value(size_t count, int value) {
    return new std::shared_ptr<falcon_core::generic::List<int>>(
        std::make_shared<falcon_core::generic::List<int>>(count, value));
}
...
void ListInt_destroy(ListIntHandle handle) {
    delete static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle);
}

void ListInt_push_back(ListIntHandle handle, int value) {
    (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->push_back(value);
}

size_t ListInt_size(ListIntHandle handle) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->size();
}

bool ListInt_empty(ListIntHandle handle) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->empty();
}

void ListInt_erase_at(ListIntHandle handle, size_t idx) {
    (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->erase_at(idx);
}

void ListInt_clear(ListIntHandle handle) {
    (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->clear();
}

int ListInt_const_at(ListIntHandle handle, size_t idx) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->at(idx);
}
...
size_t ListInt_items(ListIntHandle handle, int* out_buffer, size_t buffer_size) {
    auto& list = *static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle);
...
bool ListInt_contains(ListIntHandle handle, int value) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->contains(value);
}

size_t ListInt_index(ListIntHandle handle, int value) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle))->index(value);
}

ListIntHandle ListInt_intersection(ListIntHandle handle, ListIntHandle other) {
    auto& listA = *static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(handle);
    auto& listB = *static_cast<std::shared_ptr<falcon_core::generic::List<int>>*>(other);
    auto result = listA->intersection(listB);
    return new std::shared_ptr<falcon_core::generic::List<int>>(result);
}
