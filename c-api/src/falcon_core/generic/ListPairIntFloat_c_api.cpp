...
ListPairIntFloatHandle ListPairIntFloat_create_empty() {
    return new std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>(
...
ListPairIntFloatHandle ListPairIntFloat_allocate(size_t count) {
    return new std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>(
        std::make_shared<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>(count));
}
...
ListPairIntFloatHandle ListPairIntFloat_fill_value(size_t count, PairIntFloatHandle value) {
    ...
    return new std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>(
        std::make_shared<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>(count, stored_obj));
}
...
void ListPairIntFloat_destroy(ListPairIntFloatHandle handle) {
    delete static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle);
}

void ListPairIntFloat_push_back(ListPairIntFloatHandle handle, PairIntFloatHandle value) {
    auto stored_obj = *static_cast<falcon_core::generic::PairSP<int, float>*>(value);
    (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->push_back(stored_obj);
}

size_t ListPairIntFloat_size(ListPairIntFloatHandle handle) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->size();
}

bool ListPairIntFloat_empty(ListPairIntFloatHandle handle) {
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->empty();
}

void ListPairIntFloat_erase_at(ListPairIntFloatHandle handle, size_t idx) {
    (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->erase_at(idx);
}

void ListPairIntFloat_clear(ListPairIntFloatHandle handle) {
    (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->clear();
}

PairIntFloatHandle ListPairIntFloat_const_at(ListPairIntFloatHandle handle, size_t idx) {
    auto& obj = (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->at(idx);
...
size_t ListPairIntFloat_items(ListPairIntFloatHandle handle, PairIntFloatHandle* out_buffer, size_t buffer_size) {
    auto& list = *static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle);
...
bool ListPairIntFloat_contains(ListPairIntFloatHandle handle, PairIntFloatHandle value) {
    auto stored_obj = *static_cast<falcon_core::generic::PairSP<int, float>*>(value);
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->contains(stored_obj);
}

size_t ListPairIntFloat_index(ListPairIntFloatHandle handle, PairIntFloatHandle value) {
    auto stored_obj = *static_cast<falcon_core::generic::PairSP<int, float>*>(value);
    return (*static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle))->index(stored_obj);
}

ListPairIntFloatHandle ListPairIntFloat_intersection(ListPairIntFloatHandle handle, ListPairIntFloatHandle other) {
    auto& listA = *static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(handle);
    auto& listB = *static_cast<std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>*>(other);
    auto result = listA->intersection(listB);
    return new std::shared_ptr<falcon_core::generic::List<falcon_core::generic::Pair<int, float>>>(result);
}
