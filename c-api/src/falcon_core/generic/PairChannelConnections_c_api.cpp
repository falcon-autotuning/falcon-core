...
PairChannelConnectionsHandle PairChannelConnections_create(ChannelHandle first, ConnectionsHandle second) {
    FALCON_C_API_BEGIN
                ...
                auto first_obj= *static_cast<falcon_core::autotuner_interfaces::names::ChannelSP*>(first);
...
throw std::invalid_argument("Null handle passed to PairChannelConnections_destroy");
    ...
    delete static_cast<falcon_core::generic::PairSP<falcon_core::autotuner_interfaces::names::Channel, falcon_core::physics::device_structures::Connections>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to PairChannelConnections_first");
    ...
    return new falcon_core::autotuner_interfaces::names::ChannelSP(pair->first());
    FALCON_C_API_END(nullptr)
}
...
throw std::invalid_argument("Null handle passed to PairChannelConnections_equal");
    ...
    auto pair_a = *static_cast<falcon_core::generic::PairSP<falcon_core::autotuner_interfaces::names::Channel, falcon_core::physics::device_structures::Connections>*>(handle);
    auto pair_b = *static_cast<falcon_core::generic::PairSP<falcon_core::autotuner_interfaces::names::Channel, falcon_core::physics::device_structures::Connections>*>(other);
...
std::string json = (*static_cast<falcon_core::generic::PairSP<falcon_core::autotuner_interfaces::names::Channel,falcon_core::physics::device_structures::Connections>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to PairChannelConnections_from_json_string");
  ...
  return new falcon_core::generic::PairSP<falcon_core::autotuner_interfaces::names::Channel,falcon_core::physics::device_structures::Connections>(ptr);
    FALCON_C_API_END(nullptr)
}
}
