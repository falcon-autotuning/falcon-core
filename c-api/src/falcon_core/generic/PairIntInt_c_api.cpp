...
throw std::invalid_argument("Null handle passed to PairIntInt_destroy");
    ...
    delete static_cast<falcon_core::generic::PairSP<int, int>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to PairIntInt_equal");
    ...
    auto pair_a = *static_cast<falcon_core::generic::PairSP<int, int>*>(handle);
    auto pair_b = *static_cast<falcon_core::generic::PairSP<int, int>*>(other);
...
std::string json = (*static_cast<falcon_core::generic::PairSP<int,int>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to PairIntInt_from_json_string");
  ...
  return new falcon_core::generic::PairSP<int,int>(ptr);
    FALCON_C_API_END(nullptr)
}
}
