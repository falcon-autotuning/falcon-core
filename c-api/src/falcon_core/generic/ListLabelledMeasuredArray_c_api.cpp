...
ListLabelledMeasuredArrayHandle ListLabelledMeasuredArray_fill_value(size_t count, LabelledMeasuredArrayHandle value) {
    ...
    auto stored_obj = *static_cast<falcon_core::math::arrays::LabelledMeasuredArraySP*>(value);
...
throw std::invalid_argument("Null data handle passed to ListLabelledMeasuredArray_create");
    ...
    for (size_t i = 0; i < count; ++i) {
        vec.push_back(*static_cast<falcon_core::math::arrays::LabelledMeasuredArraySP*>(data[i])); 
    }
...
void ListLabelledMeasuredArray_destroy(ListLabelledMeasuredArrayHandle handle) {
    ...
    delete static_cast<falcon_core::generic::ListSP<falcon_core::math::arrays::LabelledMeasuredArray>*>(handle);
    FALCON_C_API_END()
}
...
for (size_t i = 0; i < n; ++i) {
    out_buffer[i] = new falcon_core::math::arrays::LabelledMeasuredArraySP(list->items()[i]);
}
    return n;
    FALCON_C_API_END(0)
}
...
throw std::invalid_argument("Null handle passed to ListLabelledMeasuredArray_to_json_string");
    ...
    std::string json = (*static_cast<falcon_core::generic::ListSP<falcon_core::math::arrays::LabelledMeasuredArray>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to ListLabelledMeasuredArray_from_json_string");
  ...
  return new falcon_core::generic::ListSP<falcon_core::math::arrays::LabelledMeasuredArray>(ptr);
    FALCON_C_API_END(nullptr)
}
}
