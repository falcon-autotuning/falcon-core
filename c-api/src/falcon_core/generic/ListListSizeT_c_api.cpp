...
const char*      ListListSizeT_to_json_string(ListListSizeTHandle handle) {
  static thread_local std::string json;
  json = static_cast<falcon_core::generic::List<falcon_core::generic::List<size_t>>*>(handle)->to_json_string();
  return json.c_str();
}
ListListSizeTHandle ListListSizeT_from_json_string(const char* json) {
  auto ptr = falcon_core::generic::List<falcon_core::generic::List<size_t>>::from_json_string<falcon_core::generic::List<falcon_core::generic::List<size_t>>>(std::string(json));
