...
ListLabelledMeasuredArray1DHandle ListLabelledMeasuredArray1D_fill_value(size_t count, LabelledMeasuredArray1DHandle value) {
    ...
    return new falcon_core::generic::List<falcon_core::math::arrays::LabelledMeasuredArray1D>(
        falcon_core::generic::List<falcon_core::math::arrays::LabelledMeasuredArray1D>(count, stored_obj));
}

ListLabelledMeasuredArray1DHandle ListLabelledMeasuredArray1D_allocate(size_t count) {
    return new falcon_core::generic::List<falcon_core::math::arrays::LabelledMeasuredArray1D>(
        falcon_core::generic::List<falcon_core::math::arrays::LabelledMeasuredArray1D>(count));
}
...
throw std::invalid_argument("Null data handle passed to ListLabelledMeasuredArray1D_create");
    ...
    std::vector<falcon_core::math::arrays::LabelledMeasuredArray1DSP> vec;
        vec.reserve(count);
    if (!data) {
    throw std::invalid_argument("Null data handle passed to ListLabelledMeasuredArray1D_create_allocation");
    }
