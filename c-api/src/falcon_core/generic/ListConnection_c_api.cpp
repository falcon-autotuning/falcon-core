...
void ListConnection_destroy(ListConnectionHandle handle) {
    ...
    delete static_cast<falcon_core::generic::ListSP<falcon_core::physics::device_structures::Connection>*>(handle);
    FALCON_C_API_END()
}
...
throw std::invalid_argument("Null handle passed to ListConnection_to_json_string");
    ...
    std::string json = (*static_cast<falcon_core::generic::ListSP<falcon_core::physics::device_structures::Connection>*>(handle))->to_json_string();
...
throw std::invalid_argument("Null string handle passed to ListConnection_from_json_string");
  ...
  return new falcon_core::generic::ListSP<falcon_core::physics::device_structures::Connection>(ptr);
    FALCON_C_API_END(nullptr)
}
}
