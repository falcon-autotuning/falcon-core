...
// @category:read
/* AUTO-DOC from cpp: Connections_is_gates | falcon_core::physics::device_structures::Connections::is_gates */
/**
 * @brief Check if all connections are gates (not ohmics).
 */
bool Connections_is_gates(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_is_ohmics | falcon_core::physics::device_structures::Connections::is_ohmics */
/**
 * @brief Check if all connections are ohmics (not gates).
 */
bool Connections_is_ohmics(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_is_dot_gates | falcon_core::physics::device_structures::Connections::is_dot_gates */
/**
 * @brief Check if all connections are dot gates (plunger or barrier).
 */
bool Connections_is_dot_gates(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_is_plunger_gates | falcon_core::physics::device_structures::Connections::is_plunger_gates */
/**
 * @brief Check if all connections are plunger gates.
 */
bool Connections_is_plunger_gates(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_is_barrier_gates | falcon_core::physics::device_structures::Connections::is_barrier_gates */
/**
 * @brief Check if all connections are barrier gates.
 */
bool Connections_is_barrier_gates(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_is_reservoir_gates | falcon_core::physics::device_structures::Connections::is_reservoir_gates */
/**
 * @brief Check if all connections are reservoir gates.
 */
bool Connections_is_reservoir_gates(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_is_screening_gates | falcon_core::physics::device_structures::Connections::is_screening_gates */
/**
 * @brief Check if all connections are screening gates.
 */
bool Connections_is_screening_gates(ConnectionsHandle handle);
// @category:read
/* AUTO-DOC from cpp: Connections_intersection | falcon_core::physics::device_structures::Connections::intersection */
/**
