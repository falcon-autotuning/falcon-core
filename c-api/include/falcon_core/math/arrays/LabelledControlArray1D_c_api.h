...
// @category:read
FALCON_CORE_C_API ListFArrayDoubleHandle LabelledControlArray1D_even_divisions(
    LabelledControlArray1DHandle handle, size_t divisions);
// @category:read
FALCON_CORE_C_API AcquisitionContextHandle
LabelledControlArray1D_label(LabelledControlArray1DHandle handle);
// @category:read
...
LabelledControlArray1D_units(LabelledControlArray1DHandle handle);
// @category:read
FALCON_CORE_C_API size_t
LabelledControlArray1D_size(LabelledControlArray1DHandle handle);
// @category:read
FALCON_CORE_C_API size_t
...
// @category:read
FALCON_CORE_C_API LabelledControlArray1DHandle
LabelledControlArray1D_abs(LabelledControlArray1DHandle handle);
// @category:read
/* AUTO-DOC from cpp: LabelledControlArray1D_min |
 * falcon_core::math::arrays::LabelledControlArray1D::min */
/**
...
LabelledControlArray1D_min_control_array(LabelledControlArray1DHandle handle,
                                         LabelledControlArray1DHandle other);
// @category:read
/* AUTO-DOC from cpp: LabelledControlArray1D_max |
 * falcon_core::math::arrays::LabelledControlArray1D::max */
/**
...
// @category:read
/* AUTO-DOC from cpp: LabelledControlArray1D_flip |
 * falcon_core::math::arrays::LabelledControlArray1D::flip */
/**
