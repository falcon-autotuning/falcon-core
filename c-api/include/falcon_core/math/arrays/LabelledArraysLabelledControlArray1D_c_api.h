...
LabelledArraysLabelledControlArray1D_create(
    ListLabelledControlArray1DHandle arrays);
// @category:allocation
FALCON_CORE_C_API LabelledArraysLabelledControlArray1DHandle
LabelledArraysLabelledControlArray1D_copy(
    LabelledArraysLabelledControlArray1DHandle handle);
// @category:deallocation
FALCON_CORE_C_API void LabelledArraysLabelledControlArray1D_destroy(
    LabelledArraysLabelledControlArray1DHandle handle);
// @category:read
FALCON_CORE_C_API ListLabelledControlArray1DHandle
LabelledArraysLabelledControlArray1D_arrays(
    LabelledArraysLabelledControlArray1DHandle handle);
// @category:read
FALCON_CORE_C_API ListAcquisitionContextHandle
LabelledArraysLabelledControlArray1D_labels(
    LabelledArraysLabelledControlArray1DHandle handle);
// @category:read
...
LabelledArraysLabelledControlArray1D_at(
    LabelledArraysLabelledControlArray1DHandle handle, size_t idx);
// @category:read
...
LabelledArraysLabelledControlArray1D_to_json_string(
    LabelledArraysLabelledControlArray1DHandle handle);
// @category:allocation
FALCON_CORE_C_API LabelledArraysLabelledControlArray1DHandle
LabelledArraysLabelledControlArray1D_from_json_string(StringHandle json);
