...
AxesMeasurementContextHandle AxesMeasurementContext_create_raw(
    const MeasurementContextHandle* data, size_t count);
...
void   AxesMeasurementContext_push_back(AxesMeasurementContextHandle handle,
...
void   AxesMeasurementContext_erase_at(AxesMeasurementContextHandle handle,
                                       size_t                       idx);
void   AxesMeasurementContext_clear(AxesMeasurementContextHandle handle);
MeasurementContextHandle AxesMeasurementContext_at(
    AxesMeasurementContextHandle handle, size_t idx);
size_t AxesMeasurementContext_items(AxesMeasurementContextHandle handle,
                                    MeasurementContextHandle*    out_buffer,
                                    size_t                       buffer_size);
bool   AxesMeasurementContext_contains(AxesMeasurementContextHandle handle,
                                       MeasurementContextHandle     value);
size_t AxesMeasurementContext_index(AxesMeasurementContextHandle handle,
                                    MeasurementContextHandle     value);
AxesMeasurementContextHandle AxesMeasurementContext_intersection(
    AxesMeasurementContextHandle handle, AxesMeasurementContextHandle other);
bool AxesMeasurementContext_equal(AxesMeasurementContextHandle a,
                                  AxesMeasurementContextHandle b);
bool AxesMeasurementContext_not_equal(AxesMeasurementContextHandle a,
                                      AxesMeasurementContextHandle b);
