...
Requires:       cereal, xtl, xtensor, xsimd, yaml-cpp, hdf5, boost, falcon-core-cpp
...
install -d "%{_sourcedir}/usr/include/falcon-core-c-api"
cp -r include/falcon_core/* "%{_sourcedir}/usr/include/falcon-core-c-api/"

%files
%license LICENSE
/usr/lib/libfalcon_core_c_api.so*
/usr/include/falcon_core_c_api
/usr/share/falcon-core-c-api/coverage
